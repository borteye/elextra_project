          ...
          <div className="content">
            <div className="section_one">
              ...
              <div className="item_summary">
                ...
                <div className="in_out_stock">In Stock</div>
                ...
                <div className="return_policy">
                  Return policy:
                  <a href="#">
                    Eligible for Return, Refund and Replacement within 30 days
                    of receipt
                  </a>
                </div>
                <div className="add_to_list">
                  {love ? (
                    <BsFillHeartFill className="love" onClick={unlikeProduct} />
                  ) : (
            ...
            <div className="section_two">
              ...
              <div
                className={
                  showDetails ? "detail_sections_hidden" : "detail_sections"
                }
              >
                <div className="product_details">
                  ...
                  <div
                    className={
                      showPDetails
                        ? "product_details_section_hidden"
                  ...
                  >
                    <p>
                      <b>
                        {/* {
                          details?.preview_aboutProduct?.[0]
                            ?.preview_aboutProductHead
                        } */}
                        mnb
                      </b>
                    </p>
                    <ul>
                      {/* {details?.preview_aboutProduct?.[1]?.preview_aboutProductList?.map(
                        (liss) => {
                          return <li>{liss.list}</li>;
                        }
                      )} */}
                      hg
                    </ul>
                ...
                <div className="product_specifications">
                  <div className="title">
                    {/* {
                      details?.preview_productSpecification?.[0]
                        ?.productSpecificationHead
                    } */}
                    xgchv
                    <div className="up_down">
                      <BiChevronUp
                  ...
                  <div
                    className={
                      showSpecDetails
                        ? "product_spec_section_hidden"
                        : "product_spec_section"
                    }
                  >
                    <ul>
                      {/* {details?.preview_productSpecification?.[1]?.productSpecificationList?.map(
                        (liss) => {
                          return <li>{liss.list}</li>;
                        }
                      )} */}
                ...
                <div className="whats_in_the_box">
                  <div className="title">
                    {/* {details?.preview_inBox?.[0]?.inBoxHead} */}
                    adfkj
                  </div>
                  <ul>
                ...
                <div className="product_warranty">
                  <div className="title">
                    {/* {details?.preview_Warranty?.[0]?.WarrantyHead} */}
                    adfdafad
                  </div>
                  <ul>
                    {/* {details?.preview_Warranty?.[1]?.WarrantyList?.map(
                      (liss) => {
                        return <li>{liss.list}</li>;
                      }
                    )} */}
